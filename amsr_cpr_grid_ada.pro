PRO amsr_cpr_grid_ada
  print,'version_2018_05_03_important_ada_250'
  lastmon='08'
  fnewmon='08'
  fnewyear='2007'
  lastyear='2007'
  nn=0LL
  LaH=2260000.0
 ; resolution=['25.0','50.0','75.0','100.0','125.0','150.0','175.0','200.0','225.0','250.0','275.0','300.0','325.0','350.0','375.0','400.0','425.0','450.0','475.0','500.0','525.0','550.0','575.0','600.0']
 ; resolution=['275.0','300.0','325.0','350.0','375.0','400.0','425.0','450.0','475.0','500.0','525.0','550.0','575.0','600.0']
;resolution=['300.0','325.0','350.0','375.0','400.0','425.0','450.0','475.0','500.0','525.0','550.0','575.0','600.0']
  ...
  ;resolu=[275.0,300.0,325.0,350.0,375.0,400.0,425.0,450.0,475.0,500.0,525.0,550.0,575.0,600.0]/2
;  resolu=[300.0,325.0,350.0,375.0,400.0,425.0,450.0,475.0,500.0,525.0,550.0,575.0,600.0]/2
  ;resolu=[25.0,50.0,75.0,100.0,125.0,150.0,175.0,200.0,225.0,250.0,275.0,300.0,325.0,350.0,375.0,400.0,425.0,450.0,475.0,500.0,525.0,550.0,575.0,600.0]/2
  resolution=['250.0']
  resolu=[250.0]/2
  ...
  path='/scratch/user/shailavi/CLOUDSAT2/'
  path1='/scratch/user/shailavi/CLOUDSAT2/'
  ...
  for r=0,0 do begin
    ...
    for i=6694,24739 do begin;1541,24738;24882  1831
      print,i
      ...
      juliday=str2int(strmid(filenames1[0],57,3))
      ls_Jul2day,juliday,year,mon,day
      hour=str2int(strmid(filenames1[0],60,2))
      min=str2int(strmid(filenames1[0],62,2))
      sec=str2int(strmid(filenames1[0],64,2))
...
print,'  a_year: ',a_year,'  a_mon: ', a_mon,'  a_day: ', a_day,'  a_hour: ',a_hour
      ...
      filename5='/scratch/user/shailavi/AMSR-E_CPR/AMSRE.L2.RainRateAE_RainStrip200kmAlongCloudSat.'+a_year+'.'+a_mon+'.'+a_day+'.'+a_hour+'*.hdf'
      ...
      for w=0,goodcnt-1 do begin
        ...
        if  fnewmon ne lastmon or i eq 24739 then begin
          ...
          hdfnamew = '/scratch/user/shailavi/rcrh/rcrh12/'+resolution[r]+'/'+lastyear+lastmon+'.h5' &  print, hdfnamew
        ...
        godidx=where((dataqua eq 0) and (rainrate ne 0 ) and (rainrate gt -999) and (lon ge lonbox[0] and lon le lonbox[1]) and (lat ge latbox[0] and lat le latbox[1]) and (FUS[3,*] ne 0 and SST le 32) and (sta le 8 ) and (rainqua ge 3 or rainrate lt 0),n_grid); and (rainrate gt 0)
